document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateLiquidLevel() {
    ...
    if (percentageFilled < 30) {
      formLiquid.style.background =
        "linear-gradient(to top, rgba(255, 107, 107, 0.7), rgba(255, 167, 107, 0.7))";
    } else if (percentageFilled < 70) {
      formLiquid.style.background =
        "linear-gradient(to top, rgba(107, 186, 255, 0.7), rgba(107, 255, 186, 0.7))";
    } else {
      formLiquid.style.background =
        "linear-gradient(to top, rgba(107, 255, 107, 0.7), rgba(186, 255, 107, 0.7))";
    }
  }
